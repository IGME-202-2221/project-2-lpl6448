...
public class AgentManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Elf prefab to spawn in on Awake
    /// </summary>
    public Agent elfPrefab;

    /// <summary>
    /// Number of elfPrefabs to spawn in on Awake
    /// </summary>
    public int numElves = 10;

    /// <summary>
    /// Snowman prefab to spawn in on Awake
    /// </summary>
    public Agent snowmanPrefab;

    /// <summary>
    /// Number of snowmanPrefabs to spawn in on Awake
    /// </summary>
